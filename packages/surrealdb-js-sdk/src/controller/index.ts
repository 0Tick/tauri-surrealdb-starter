import { createTauriEngines } from "../engine";
...
export class ConnectionController
  implements SurrealProtocol, EventPublisher<ConnectionEvents>
{
  ...
  public async ready(): Promise<void> {
    ...
    const [result] = await this.#eventPublisher.subscribeFirst(
      "connected",
      "error",
    );
  ...
  public assertFeature(feature: Feature): void {
    if (!this.#engine || !this.#cachedVersion)
      throw new ConnectionUnavailableError();
  ...
  async use(
    what: Nullable<NamespaceDatabase>,
    session: Session,
